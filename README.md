[![docs](https://github.com/kisstokilltime/docs.audioetch/actions/workflows/docs.yml/badge.svg)](https://github.com/kisstokilltime/docs.audioetch/actions/workflows/docs.yml) [![pages](https://github.com/kisstokilltime/docs.audioetch/actions/workflows/pages.yml/badge.svg)](https://github.com/kisstokilltime/docs.audioetch/actions/workflows/pages.yml)

# docs.audioetch

The **public documentation** site for [`kisstokilltime/audioetch`](https://github.com/kisstokilltime/audioetch). Built from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs) as a self-contained [Hugo](https://gohugo.io) site, published to GitHub Pages.
