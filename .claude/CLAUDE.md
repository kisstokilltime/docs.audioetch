# `docs.audioetch` — public documentation repository

This is the **public** documentation site for `kisstokilltime/audioetch`, created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages (and/or Cloudflare).
...
- The Pages workflow ([`.github/workflows/pages.yml`](../.github/workflows/pages.yml)) is always present and **self-skips while the repo is private**, deploying automatically once the repo is public and Pages is enabled.
